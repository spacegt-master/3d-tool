...
import { usePropertiesPanelStore } from "./properties-panle";
...
export const useModelStore = defineStore("model", () => {
  ...
  const { threshold, width, height, panelThickness, deep } =
    storeToRefs(propertiesPanelStore);
  ...
  function adsorptionFramework(object: Object3D) {
    let isFullWidth =
      object.scale.x >=
  ...
  function calculationFormula(meshData: MeshData) {
